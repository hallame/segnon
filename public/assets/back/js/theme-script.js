...
document.querySelector("html").setAttribute('data-sidebar', localStorage.getItem('nightblue') || 'nightblue');
...
<div class="sidebar-contact ">
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        savedSidebarTheme = localStorage.getItem('nightblue');
