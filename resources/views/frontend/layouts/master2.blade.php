...
<head>
    @php
        $defaultTitle = "Marketplace d'artisans & créateurs africains";
        $pageTitle    = trim($__env->yieldContent('title')) ?: $defaultTitle;

        $metaTitle = trim($__env->yieldContent('meta_title')) ?: $pageTitle;
        $metaDescription = trim($__env->yieldContent('meta_description'))
            ?: "MYLMARK est un marché digital dédié aux artisans, créateurs et talents africains : objets d'art, déco, mode, cadeaux et pièces uniques.";
    ...
    {{-- Favicon de base (à adapter si tu as les fichiers) --}}
