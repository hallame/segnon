...
<div class="row g-3">
  ...
  <div class="col-md-4 simple-only">
    ...
    <input type="number" step="1" name="old_price" class="form-control"
           value="{{ old('old_price', $product->old_price ?? 0) }}" placeholder="Ex : 169000">
  </div>
  ...
  <div class="col-md-4 d-flex align-items-end simple-only">
    ...
    <div class="col-md-4">
        ...
        <small class="text-muted d-block mt-1">
            Formats acceptés : MP4 • Max 20 Mo • Durée recommandée : 30-60 secondes
        </small>
...
<script>
    ...
    window.deleteMedia = async function(productId, mediaId, btn){
        ...
        const res = await fetch(`{{ url('/mpanel/products') }}/${productId}/media/${mediaId}`, {
        method: 'DELETE',
