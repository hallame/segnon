  ...
  <div class="table-responsive">
    <table class="table align-middle mb-0">
      ...
      @forelse($orders as $o)
        ...
        @endphp
        <tr>
          <td><a href="{{ route('partners.orders.show',$o) }}" class="fw-semibold">{{ $o->reference }}</a></td>
          <td>
          ...
          <td class="text-nowrap">
            <a href="{{ route('partners.orders.show',$o) }}" class="btn btn-sm btn-outline-primary">Voir</a>
          </td>
        </tr>
      @empty
