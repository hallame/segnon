...
@section('title') Ajouter une Chambre @endsection
@section('content')
    ...
    <form action="{{ route('partners.rooms.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        @include('partials.rooms._form', ['room' => null, 'hotels' => $hotels, 'facilities' => $facilities])
    </form>
@endsection
